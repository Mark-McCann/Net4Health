...
#summary(ergm.data.control.imputed[[1]][[1]] ~ edges 
#     + mutual
#     + gwesp()
#     + nodematch("gender")
#     + nodefactor("gender")
...
control.imp.results <- run.imputed.ergms(dataset = ergm.data.control.imputed, 
                                         savename = "control",
                                         num_iters = 20)

save(baseline.imp.results , file= "baseline.imp.results.rdata")
save(control.imp.results , file= "control.imp.results.rdata")


setwd("//192.168.0.17/stash_sna/Data/AnonymisedData/working data/")
load("baseline.imp.results141119.rdata")
dir()
